...
public class PrenotaETOrdinaController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        // Mostra un form simile a prenotaTavolo.jsp, ma specifico per "prenota e ordina"
    ...
    protected void doPost(HttpServletRequest request,
        ...
        // Salvo in sessione l'id della prenotazione per legare l'ordine
        session.setAttribute("prenotazioneCorrenteId", prenotazioneId);
        session.setAttribute("modalitaServizio", "RISTORANTE");

        // Ora lo mando al menu dove sceglierà i piatti (riusi /menu che già hai)
